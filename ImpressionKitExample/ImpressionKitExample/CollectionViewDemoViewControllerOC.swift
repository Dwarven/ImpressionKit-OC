//
//  CollectionViewDemoViewControllerOC.swift
//  ImpressionKit-OC
//
...
class CollectionViewDemoViewControllerOC: UIViewController, UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout {
...
private class OCCell: UICollectionViewCell {
    ...
    fileprivate func updateUI(state: ImpkStateModel) {
        ...
        case .inScreen:
            ...
            var duration = UIView.impk_durationThreshold
            if let impk_durationThreshold = self.impk_durationThreshold {
                duration = impk_durationThreshold.doubleValue
            }
